...
台帳にはIssue、PR、Actions、記事Markdown、見出し画像、note投稿パッケージ、公開後のnote URLを集約します。note公開後はGitHub Actionsの`Register published note URL`を手動実行すると、公開URLを台帳と記憶へ追記するPRが作られます。
